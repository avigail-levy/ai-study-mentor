...
//                    if (nr === end.r && nc === end.c) {
//                     let direction = '⬆️'; // ברירת מחדל
//                     if (nc > start.c) direction = '➡️';
//                     else if (nc < start.c) direction = '⬅️';
//                     else if (nr > start.r) direction = '⬆️'; // קדימה
//                     else if (nr < start.r) direction = '⬇️'; // אחורה
                    
//                     return { distance: dist + 1, direction: direction };
//                 }
//                 }
